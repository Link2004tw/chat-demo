                ...
                <div className="w-full max-w-md">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-gray-600 dark:text-gray-400">
                            Join the chat and start connecting today
                        </p>
                    </div>
                        ...
                        <SignUp
                            appearance={{
                                ...
                                elements: {
                                    ...
                                    otpInputField: "bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white rounded-xl",
                                },
                            }}
                            routing="path"
                            path="/sign-up"
